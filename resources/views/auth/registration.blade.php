		...
		<form action="{{route('registration.user')}}" method="POST">
			...
			@csrf
                ...
                @if (Session::has('succuess'))
                    <div class="alert alert-success">{{ Session::get('succuess') }}</div>
                    @endif
                @if (Session::has('fail'))
	...
	<div class="overlay-container">
		<div class="overlay">
			...
			<div class="overlay-panel overlay-right">
                ...
                <img src="https://cdn.pic.in.th/file/picinth/-1_preview_rev_15beae3dcd532a37b.png"/>
